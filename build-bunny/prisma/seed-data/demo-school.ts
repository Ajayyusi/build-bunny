 ...
 * levels (the demo child did the practice too). The four
...
export const STUDENTS: StudentSeed[] = [
  // ── Grade 3A (Sara Haddad) ──
  {
    ...
    // rewrites her history. New levels are appended at the end of a world;
    // when a practice module was added to the first three worlds, matching
    // full-star entries were spliced in here at the same positions, and
