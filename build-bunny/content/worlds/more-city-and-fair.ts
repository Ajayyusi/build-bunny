  ...
  levels: [
    {
      ...
      teacherNotes: { en: "Negative change. The 'add' field accepts -9..9; children who add +1 end on 6." },
      difficulty: "MEDIUM",
    ...
    },
    {
      ...
      teacherNotes: { en: "Connects loops to multiplication. Four blocks earn three stars." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 5,
    ...
    },
    {
      ...
      teacherNotes: { en: "Common wrong answers: 6 (ignoring the starting 2) and 2 (ignoring the loop)." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 4,
    ...
    },
    {
      ...
      teacherNotes: { en: "Misconception check: 2 (counting the definition only) or 3 (counting calls only)." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 4,
    ...
    },
    {
      ...
      teacherNotes: { en: "Only the trick body is wrong. Children who rewrite the whole program without the trick can still pass with two stars." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 5,
    ...
    },
    {
      ...
      teacherNotes: { en: "Eight blocks with the trick. usedBlock doTrick is secondary: plain solutions are PARTIAL." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 6,
    ...
    },
    {
      ...
      teacherNotes: { en: "Text-code ordering bridges blocks to typed code. Ask why say() must be after the closing brace." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 5,
...
export const fairMore: LevelFixture[] = [
  {
    ...
    teacherNotes: { en: "Starter maze for ages 7–8: 4×3 board, rocks only, no loops needed." },
    difficulty: "EASY",
  ...
  },
  {
    ...
    teacherNotes: { en: "Water is fatal like rocks; both count as obstacles. Six blocks with two Repeats is the three-star line." },
    difficulty: "MEDIUM",
  ...
  },
  {
    ...
    teacherNotes: { en: "Open capstone on an 8×6 board. Encourage children to swap and solve each other's mazes on paper afterwards." },
    difficulty: "HARD",
    recommendedGradeMin: 5,
    recommendedGradeMax: 7,
    estimatedMinutes: 12,
