...
export const meadowMore: LevelFixture[] = [
  {
    ...
    teacherNotes: { en: "Starter practice for Repeat. Five plain hops pass with two stars; the loop earns three." },
    difficulty: "EASY",
  ...
  },
  {
    ...
    teacherNotes: { en: "Five blocks. Children who turn left first hop off the top of the map — a located bump that is worth acting out." },
    difficulty: "EASY",
    recommendedGradeMin: 3,
    recommendedGradeMax: 4,
    estimatedMinutes: 4,
  ...
  },
  {
    ...
    teacherNotes: { en: "Multi-block loop body. Nine plain blocks pass with two stars; six with the loop earn three." },
    difficulty: "MEDIUM",
    recommendedGradeMin: 3,
...
export const forestMore: LevelFixture[] = [
  {
    ...
    teacherNotes: { en: "Two variants graded together. A program that always turns fails the clear map; one that never turns bumps the tree." },
    difficulty: "MEDIUM",
  ...
  },
  {
    ...
    teacherNotes: { en: "Only the two turns are wrong. Ask children to say which step first went wrong before they touch a block." },
    difficulty: "EASY",
    recommendedGradeMin: 4,
    recommendedGradeMax: 6,
    estimatedMinutes: 4,
  ...
  },
  {
    ...
    teacherNotes: { en: "Two variants of different lengths. A counted Repeat fits only one of them." },
    difficulty: "MEDIUM",
    recommendedGradeMin: 4,
    recommendedGradeMax: 6,
    estimatedMinutes: 4,
...
export const labMore: LevelFixture[] = [
  {
    ...
    teacherNotes: { en: "Collect placed first in the body grabs air (collectFail) and leaves cells behind: PARTIAL with located feedback." },
    difficulty: "MEDIUM",
    recommendedGradeMin: 4,
    recommendedGradeMax: 6,
    estimatedMinutes: 5,
  ...
  },
  {
    ...
    teacherNotes: { en: "Five steps with a strict dependency chain. Ask children to justify each neighbour pair." },
    difficulty: "EASY",
    recommendedGradeMin: 4,
    recommendedGradeMax: 6,
    estimatedMinutes: 3,
  ...
  },
  {
    ...
    teacherNotes: { en: "Wall-following on two variants (a one-turn corridor and a clockwise spiral). The turn must be inside the If and the hop after it." },
    difficulty: "HARD",
