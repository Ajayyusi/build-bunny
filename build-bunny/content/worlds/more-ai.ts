  ...
  levels: [
    {
      ...
      teacherNotes: {
        ...
        ar: "يُقيَّم بالإكمال. اربطه بسياسة المدرسة لمكافحة التنمّر، وسمِّ الأشخاص الذين يمكن للأطفال إخبارهم. «التقط صورة للشاشة وأخبر» هي العادة العملية المطلوبة.",
      },
      difficulty: "MEDIUM",
    ...
    },
    {
      ...
      teacherNotes: { en: "Completion-based. Children should NOT type real passwords anywhere in class; this level only discusses them.", ar: "يُقيَّم بالإكمال. يجب ألّا يكتب الأطفال كلمات مرور حقيقية في أي مكان داخل الفصل؛ فهذا المستوى يناقشها فقط." },
      difficulty: "EASY",
      recommendedGradeMin: 3,
      recommendedGradeMax: 7,
      estimatedMinutes: 6,
    ...
    },
    {
      ...
      teacherNotes: { en: "Completion-based. Media-literacy basics: adverts, 'free' games with paid items, prize pop-ups.", ar: "يُقيَّم بالإكمال. أساسيات التربية الإعلامية: الإعلانات، والألعاب «المجانية» التي فيها عناصر مدفوعة، ونوافذ الجوائز المنبثقة." },
      difficulty: "EASY",
      recommendedGradeMin: 3,
    ...
    },
    {
      ...
      teacherNotes: { en: "Mirror of berry-sorter with size deciding. Colour is usually right in the pool, so teaching only typical seeds fails the rare-looking test seeds. Ask: how would the machine know which measurement matters?", ar: "صورة معكوسة من مستوى «علّم الأرنب» (berry-sorter) لكن الحجم هنا هو الذي يحسم. اللون يكون صحيحًا في الغالب ضمن مجموعة البذور، لذا فإن التعليم بالبذور المعتادة وحدها يفشل مع بذور الاختبار ذات المظهر النادر. اسأل: كيف ستعرف الآلة أي قياس هو المهم؟" },
      difficulty: "EASY",
  ...
  levels: [
    {
      ...
      teacherNotes: { en: "Harder follow-up to Two Piles: clusters closer, bar slightly lower. Reference placement verified in tests.", ar: "متابعة أصعب لمستوى «كومتان في الرمل»: المجموعات أقرب، وحدّ النجاح أقل قليلًا. الوضع المرجعي متحقَّق منه في الاختبارات." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 4,
      recommendedGradeMax: 7,
      estimatedMinutes: 6,
    ...
    },
    {
      ...
      teacherNotes: { en: "Threshold at 0.3 on colour. Links to Where Does the Line Go?: boundary examples matter most.", ar: "العتبة عند 0.3 على اللون. يرتبط بمستوى «أين يمرّ الخط؟»: الأمثلة القريبة من الحدّ هي الأهم." },
      difficulty: "MEDIUM",
      recommendedGradeMin: 5,
      recommendedGradeMax: 7,
      estimatedMinutes: 7,
